 ...
 * Full expense management: list, search, filter, add/edit/delete, export, pagination
 */
...
export default function ExpensesPage() {
  ...
  // Re-fetch whenever filters change (debounced for search)
  useEffect(() => {
  ...
  const handleSubmit = async (formData) => {
    ...
    setShowModal(false);
    fetchExpenses(filters); // Refresh list after mutation
  };
